...
const NUM_LEDS: usize = NUM_ROWS * NUM_COLS;
...
fn main() {
    ...
    // for i in 0..NUM_LEDS {
    //     set_led_by_num(i, 0, 32, 0, &mut data);
...
fn set_led_by_num(led_num: usize, r: u8, g: u8, b: u8, data: &mut [RGB8; NUM_LEDS]) {
    ...
    let num_rows_i: usize = num_rows_f as usize;
    ...
    let mut led = data[new_led_num];
    led.r = r;
    led.g = g;
    led.b = b;
    data[new_led_num] = led;
}
